...
#cities data
uscities_path = 'uscities.csv'
uscities = pd.read_csv(uscities_path)
uscities = uscities[["city", "state_id", "lat", "lng","county_fips","state_name"]]

#walmart data
df_path = r'C:\Users\inesn\Documents\Mines\2A\TR\econometrics\data_collection\plein_de_data\fandom_traitées.csv'
...
geo_map_data = gpd.GeoDataFrame(map_data, 
...
geo_map_data.explore(column='Walmart store entry or/and exit (2016, per city)', 
